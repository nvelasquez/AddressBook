...
namespace AddressBook.Controllers
{
    public class PhonesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Type,Number,ContactId")] Phone phone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Type,Number,ContactId")] Phone phone)
        {
            if (ModelState.IsValid)
            {
